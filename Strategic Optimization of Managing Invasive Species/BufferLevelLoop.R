...
for (b in 1:1){
  ...
  buffer = buffers[b]
    ...
    for (i in 1:3){
      ...
      print("wvfrt2done")
      ip_rank_ply = ip_rank(inf_Ip,host, np=8,natural_distance_scale[[1]],reproductive_rate[[1]],Wcoef,rg ,10)
      ip2 = ip_treat(ip_rank_ply, budget, buffer, cost_per_meter_sq, inf)
      print("IPdone")
      
      #ip_rank_ply2 = ip_rank2(inf_Ip2,host, np=8,natural_distance_scale[[1]],reproductive_rate[[1]],Wcoef,rg ,20)
      ...
      loop_nm = paste("Bf", as.character(b-1),"Year", as.character(i),sep="")
      
      no_nm = paste("Q:/Shared drives/APHIS  Projects/eRADS/workingPapers/simulation/AllFiles3/result/buffer/",host_nm, loop_nm, "No.tif",sep="")
      rd_nm = paste("Q:/Shared drives/APHIS  Projects/eRADS/workingPapers/simulation/AllFiles3/result/buffer/",host_nm, loop_nm, "Rd.tif",sep="")
      hinf_nm = paste("Q:/Shared drives/APHIS  Projects/eRADS/workingPapers/simulation/AllFiles3/result/buffer/",host_nm, loop_nm, "Hinf.tif",sep="")
      hst0_nm = paste("Q:/Shared drives/APHIS  Projects/eRADS/workingPapers/simulation/AllFiles3/result/buffer/",host_nm, loop_nm, "Hst0.tif",sep="")
      hst_nm = paste("Q:/Shared drives/APHIS  Projects/eRADS/workingPapers/simulation/AllFiles3/result/buffer/",host_nm, loop_nm, "Hst.tif",sep="")
      hst2_nm = paste("Q:/Shared drives/APHIS  Projects/eRADS/workingPapers/simulation/AllFiles3/result/buffer/",host_nm, loop_nm, "Hst2.tif",sep="")
      ip_nm = paste("Q:/Shared drives/APHIS  Projects/eRADS/workingPapers/simulation/AllFiles3/result/buffer/",host_nm, loop_nm, "Ip.tif",sep="")
      wvfrt1_nm = paste("Q:/Shared drives/APHIS  Projects/eRADS/workingPapers/simulation/AllFiles3/result/buffer/",host_nm, loop_nm, "Wvfrt1.tif",sep="")
      wvfrt2_nm = paste("Q:/Shared drives/APHIS  Projects/eRADS/workingPapers/simulation/AllFiles3/result/buffer/",host_nm, loop_nm, "Wvfrt2.tif",sep="")
      ip_nm2 = paste("Q:/Shared drives/APHIS  Projects/eRADS/workingPapers/simulation/AllFiles3/result/buffer/",host_nm, loop_nm, "Ip2.tif",sep="")
      ...
      dfnm = paste("Q:/Shared drives/APHIS  Projects/eRADS/workingPapers/simulation/AllFiles3/result/buffer/","bf", as.character(b),"Y", as.character(i),".csv" ,sep="")
      #dfsm$Year=c(1:3)
      write.csv(dfsm,dfnm)
