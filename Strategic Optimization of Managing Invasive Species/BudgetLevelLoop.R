...
for (b in 2:2){
  ...
  budget = budgets[b]
    ...
    for (i in 1:3){
      ...
      no_nm = paste("Q:/Shared drives/APHIS  Projects/eRADS/workingPapers/simulation/AllFiles3/result/budget/",host_nm, loop_nm, "NoWC.tif",sep="")
      rd_nm = paste("Q:/Shared drives/APHIS  Projects/eRADS/workingPapers/simulation/AllFiles3/result/budget/",host_nm, loop_nm, "RdWC.tif",sep="")
      hinf_nm = paste("Q:/Shared drives/APHIS  Projects/eRADS/workingPapers/simulation/AllFiles3/result/budget/",host_nm, loop_nm, "HinfWC.tif",sep="")
      hst0_nm = paste("Q:/Shared drives/APHIS  Projects/eRADS/workingPapers/simulation/AllFiles3/result/budget/",host_nm, loop_nm, "Hst0WC.tif",sep="")
      hst_nm = paste("Q:/Shared drives/APHIS  Projects/eRADS/workingPapers/simulation/AllFiles3/result/budget/",host_nm, loop_nm, "HstWC.tif",sep="")
      hst2_nm = paste("Q:/Shared drives/APHIS  Projects/eRADS/workingPapers/simulation/AllFiles3/result/budget/",host_nm, loop_nm, "Hst2WC.tif",sep="")
      ip_nm = paste("Q:/Shared drives/APHIS  Projects/eRADS/workingPapers/simulation/AllFiles3/result/budget/",host_nm, loop_nm, "IpWC.tif",sep="")
      wvfrt1_nm = paste("Q:/Shared drives/APHIS  Projects/eRADS/workingPapers/simulation/AllFiles3/result/budget/",host_nm, loop_nm, "Wvfrt1WC.tif",sep="")
      wvfrt2_nm = paste("Q:/Shared drives/APHIS  Projects/eRADS/workingPapers/simulation/AllFiles3/result/budget/",host_nm, loop_nm, "Wvfrt2WC.tif",sep="")
      ip_nm2 = paste("Q:/Shared drives/APHIS  Projects/eRADS/workingPapers/simulation/AllFiles3/result/budget/",host_nm, loop_nm, "Ip2WC.tif",sep="")
