...
for (dp in 1:3){
  ...
  for (b in 2:2){
    ...
    reproductive_rate[[1]] = repros[dp]
    natural_distance_scale[[1]] = disp[dp]
    ...
    for (i in 1:3){
      ...
      print("wvfrt2done")
      ip_rank_ply = ip_rank(inf_Ip,host, np=8,1,reproductive_rate[[1]],Wcoef,rg ,10)
      ...
      loop_nm = paste("DP", as.character(dp),"Year", as.character(i),sep="")
      
      no_nm = paste("Q:/Shared drives/APHIS  Projects/eRADS/workingPapers/simulation/AllFiles3/result/budget/",host_nm, loop_nm, "NoDP.tif",sep="")
      rd_nm = paste("Q:/Shared drives/APHIS  Projects/eRADS/workingPapers/simulation/AllFiles3/result/budget/",host_nm, loop_nm, "RdDP.tif",sep="")
      hinf_nm = paste("Q:/Shared drives/APHIS  Projects/eRADS/workingPapers/simulation/AllFiles3/result/budget/",host_nm, loop_nm, "HinfDP.tif",sep="")
      hst0_nm = paste("Q:/Shared drives/APHIS  Projects/eRADS/workingPapers/simulation/AllFiles3/result/budget/",host_nm, loop_nm, "Hst0DP.tif",sep="")
      hst_nm = paste("Q:/Shared drives/APHIS  Projects/eRADS/workingPapers/simulation/AllFiles3/result/budget/",host_nm, loop_nm, "HstDP.tif",sep="")
      hst2_nm = paste("Q:/Shared drives/APHIS  Projects/eRADS/workingPapers/simulation/AllFiles3/result/budget/",host_nm, loop_nm, "Hst2DP.tif",sep="")
      ip_nm = paste("Q:/Shared drives/APHIS  Projects/eRADS/workingPapers/simulation/AllFiles3/result/budget/",host_nm, loop_nm, "IpDP.tif",sep="")
      wvfrt1_nm = paste("Q:/Shared drives/APHIS  Projects/eRADS/workingPapers/simulation/AllFiles3/result/budget/",host_nm, loop_nm, "Wvfrt1DP.tif",sep="")
      wvfrt2_nm = paste("Q:/Shared drives/APHIS  Projects/eRADS/workingPapers/simulation/AllFiles3/result/budget/",host_nm, loop_nm, "Wvfrt2DP.tif",sep="")
      ip_nm2 = paste("Q:/Shared drives/APHIS  Projects/eRADS/workingPapers/simulation/AllFiles3/result/budget/",host_nm, loop_nm, "Ip2DP.tif",sep="")
